...
int main(int argc, char *argv[])
{
  ...
  unsigned int oR =0,nR =0, oG = 0, nG = 0,oB = 0,nB = 0;
  ...
  while (1) {
     ...
     nR = (rgb_knobs_value & 0x00FF0000)>>18;
     nG = (rgb_knobs_value & 0x0000FF00) >> 10;
     nB = (rgb_knobs_value & 0x000000FF) >>2;
     
     
     aR = (nR > oR)? nR-oR : oR-nR;
     aG = (nG > oG)? nG-oG : oG-nG;
     aB = (nB > oB)? nB-oB : oB-nB;
